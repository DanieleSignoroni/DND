...
<%
  ...
  WebForm YPianoCaricoToyotaForm =  
     new com.thera.thermfw.web.WebForm(request, response, "YPianoCaricoToyotaForm", "YPianoCaricoToyota", null, "com.thera.thermfw.web.servlet.FormActionAdapter", false, false, true, true, true, true, null, 0, true, "it/dnd/thip/logis/lgb/YPianoCaricoToyota.js"); 
...
<!--<span class="multisearchform" id="Reparto"></span>-->
                  ...
                  <tr>
                    <td valign="top">
                      <%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "YPianoCaricoToyota", "IdMagazzinoFisicoStock", null); 
   label.setParent(YPianoCaricoToyotaForm); 
%><label class="<%=label.getClassType()%>" for="MagFisicoStock"><%label.write(out);%></label><%}%>
                    </td>
                    <td valign="top">
                      <% 
  WebMultiSearchForm YPianoCaricoToyotaMagFisicoStock =  
     new com.thera.thermfw.web.WebMultiSearchForm("YPianoCaricoToyota", "MagFisicoStock", false, false, true, 1, null, null); 
  YPianoCaricoToyotaMagFisicoStock.setParent(YPianoCaricoToyotaForm); 
  YPianoCaricoToyotaMagFisicoStock.write(out); 
%>
<!--<span class="multisearchform" id="MagFisicoStock"></span>-->
                    </td>
                  </tr>
                  <tr>
                    <td valign="top">
...
<!--<span class="multisearchform" id="UbicazioneStock"></span>-->
                  ...
                  <tr>
                    <td valign="top">
                      <%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "YPianoCaricoToyota", "IdMagazzinoFisicoPrelievo", null); 
   label.setParent(YPianoCaricoToyotaForm); 
%><label class="<%=label.getClassType()%>" for="MagFisicoPrl"><%label.write(out);%></label><%}%>
                    </td>
                    <td valign="top">
                      <% 
  WebMultiSearchForm YPianoCaricoToyotaMagFisicoPrl =  
     new com.thera.thermfw.web.WebMultiSearchForm("YPianoCaricoToyota", "MagFisicoPrl", false, false, true, 1, null, null); 
  YPianoCaricoToyotaMagFisicoPrl.setParent(YPianoCaricoToyotaForm); 
  YPianoCaricoToyotaMagFisicoPrl.write(out); 
%>
<!--<span class="multisearchform" id="MagFisicoPrl"></span>-->
                    </td>
                  </tr>
                  <tr>
                    <td valign="top">
