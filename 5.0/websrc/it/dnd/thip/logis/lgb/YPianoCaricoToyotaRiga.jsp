...
%> 
                  ...
                  <tr>
                    <td valign="top">
                      <%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "YPianoCaricoToyotaRiga", "TipoMissione", null); 
   label.setParent(YPianoCaricoToyotaRigaForm); 
%><label class="<%=label.getClassType()%>" for="TipoMissione"><%label.write(out);%></label><%}%>
                    </td>
                    <td valign="top">
                      <% 
  WebComboBox YPianoCaricoToyotaRigaTipoMissione =  
     new com.thera.thermfw.web.WebComboBox("YPianoCaricoToyotaRiga", "TipoMissione", null); 
  YPianoCaricoToyotaRigaTipoMissione.setParent(YPianoCaricoToyotaRigaForm); 
%>
<select id="<%=YPianoCaricoToyotaRigaTipoMissione.getId()%>" name="<%=YPianoCaricoToyotaRigaTipoMissione.getName()%>"><% 
  YPianoCaricoToyotaRigaTipoMissione.write(out); 
%> 
</select>
                    </td>
                  </tr>
