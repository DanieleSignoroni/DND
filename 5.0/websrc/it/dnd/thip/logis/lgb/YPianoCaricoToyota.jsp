...
%> 
                  ...
                  <tr>
                    <td valign="top">
                      <%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "YPianoCaricoToyota", "NumeroRitornoVersamento", null); 
   label.setParent(YPianoCaricoToyotaForm); 
%><label class="<%=label.getClassType()%>" for="NumeroRitornoVersamento"><%label.write(out);%></label><%}%>
                    </td>
                    <td valign="top">
                      <% 
  WebTextInput YPianoCaricoToyotaNumeroRitornoVersamento =  
     new com.thera.thermfw.web.WebTextInput("YPianoCaricoToyota", "NumeroRitornoVersamento"); 
  YPianoCaricoToyotaNumeroRitornoVersamento.setParent(YPianoCaricoToyotaForm); 
%>
<input class="<%=YPianoCaricoToyotaNumeroRitornoVersamento.getClassType()%>" id="<%=YPianoCaricoToyotaNumeroRitornoVersamento.getId()%>" maxlength="<%=YPianoCaricoToyotaNumeroRitornoVersamento.getMaxLength()%>" name="<%=YPianoCaricoToyotaNumeroRitornoVersamento.getName()%>" size="<%=YPianoCaricoToyotaNumeroRitornoVersamento.getSize()%>"><% 
  YPianoCaricoToyotaNumeroRitornoVersamento.write(out); 
%>
