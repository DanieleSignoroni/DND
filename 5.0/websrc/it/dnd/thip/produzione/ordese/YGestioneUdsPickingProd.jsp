...
<!--<span class="multisearchform" id="TipoUds"></span>-->
                   ...
                   <tr>
                    <td valign="top">
                      <%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "YGestioneUdsPickingProd", "IdArticolo", null); 
   label.setParent(YGestioneUdsPickingProdForm); 
%><label class="<%=label.getClassType()%>" for="Articolo"><%label.write(out);%></label><%}%>
                    </td>
                    <td valign="top">
                      <% 
  WebMultiSearchForm YGestioneUdsPickingProdArticolo =  
     new com.thera.thermfw.web.WebMultiSearchForm("YGestioneUdsPickingProd", "Articolo", false, false, true, 1, null, null); 
  YGestioneUdsPickingProdArticolo.setParent(YGestioneUdsPickingProdForm); 
  YGestioneUdsPickingProdArticolo.write(out); 
%>
