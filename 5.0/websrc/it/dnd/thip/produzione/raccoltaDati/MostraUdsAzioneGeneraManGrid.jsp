...
<input type="hidden" name="IdCodiceRigaLista" value="<%=request.getParameter("IdCodiceRigaLista")%>">
<input type="hidden" name="IdCodiceLista" value="<%=request.getParameter("IdCodiceLista")%>">
