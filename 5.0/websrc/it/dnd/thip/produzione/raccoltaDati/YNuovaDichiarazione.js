...
RilevDatiPrdTSOL = function() {
	...
	parent.document.getElementById('YChiudiListaTesta').style.display = displayBlock; //71979
}
...
function yChiusuaListaTestaAction() {
	setInnerText(document.getElementById("ErroriList"), "");
	var className = eval("document.forms[0].thClassName.value");
	runActionDirect('CHIUSURA_LISTA_TESTA', 'action_submit', className, null, 'same', 'no');
}