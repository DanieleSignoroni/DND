...
<!-- 71979 Inizio -->
<td align="left">
	<button id="YChiudiListaTesta" class="btnFooter" type="button"
		onclick="yChiusuaListaTestaAction()">Chiusura lista</button>
</td>
<!-- 71979 Fine -->
<script>
...
//71946	Fine
//71979 Inizio
function yChiusuaListaTestaAction(){
	var rilframe = document.getElementById('rilframe');
	rilframe.contentWindow.yChiusuaListaTestaAction();
}
//71979 Fine
</script>