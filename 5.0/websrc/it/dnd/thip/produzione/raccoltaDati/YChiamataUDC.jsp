...
<%
  ...
  WebForm RilevDatiPrdTSForm =  
     new com.thera.thermfw.web.WebForm(request, response, "RilevDatiPrdTSForm", "RilevDatiPrdTS", null, "it.thera.thip.produzione.raccoltaDati.web.RilevDatiPrdTSFormActionAdapter", false, false, false, false, true, true, null, 1, true, "it/dnd/thip/produzione/raccoltaDati/YChiamataUDC.js"); 
				...
				<td>
					<table cellpadding="3" cellspacing="3">
						<tr style="display:none">
							<td colspan="2"><label id="Titolo" style="font-weight:bold;">CHIAMATA MANUALE UDC</label></td>
						</tr>
						<tr style="display: none">
							<td nowrap><label>Articolo</label></td>
							<td colspan="2"><% 
...
%>
<input class="<%=RilevDatiPrdTSIdArticolo.getClassType()%>" id="<%=RilevDatiPrdTSIdArticolo.getId()%>" maxlength="<%=RilevDatiPrdTSIdArticolo.getMaxLength()%>" name="<%=RilevDatiPrdTSIdArticolo.getName()%>" size="<%=RilevDatiPrdTSIdArticolo.getSize()%>" type="text"><% 
...
%>
						...
						<tr style="display: none">
							<td nowrap><label>Numero rit:</label></td>
							<td colspan="2"><% 
  WebTextInput RilevDatiPrdTSNumeroRitornoVersamento =  
     new com.thera.thermfw.web.WebTextInput("RilevDatiPrdTS", "NumeroRitornoVersamento"); 
  RilevDatiPrdTSNumeroRitornoVersamento.setOnBlur("recuperaArticoloAttivitaFinale()"); 
  RilevDatiPrdTSNumeroRitornoVersamento.setParent(RilevDatiPrdTSForm); 
%>
<input class="<%=RilevDatiPrdTSNumeroRitornoVersamento.getClassType()%>" id="<%=RilevDatiPrdTSNumeroRitornoVersamento.getId()%>" maxlength="<%=RilevDatiPrdTSNumeroRitornoVersamento.getMaxLength()%>" name="<%=RilevDatiPrdTSNumeroRitornoVersamento.getName()%>" size="<%=RilevDatiPrdTSNumeroRitornoVersamento.getSize()%>" type="text"><% 
  RilevDatiPrdTSNumeroRitornoVersamento.write(out); 
%>
</td>
						</tr>
					</table>
