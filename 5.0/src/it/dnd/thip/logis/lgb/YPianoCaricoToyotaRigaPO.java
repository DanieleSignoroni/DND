...
public abstract class YPianoCaricoToyotaRigaPO extends DocumentoBaseRiga implements BusinessObject, Authorizable, Deletable, Child, Conflictable {
	...
	protected char iTipoMissione = TipoMissionePianoCaricoRigaToyota.PRELIEVO;
	...
	public YPianoCaricoToyotaRigaPO() {
		...
		setTipoMissione(TipoMissionePianoCaricoRigaToyota.PRELIEVO);
	}
	...
	public char getTipoMissione() {
		return iTipoMissione;
	}

	public void setTipoMissione(char iTipoMissione) {
		this.iTipoMissione = iTipoMissione;
		setDirty();
	}
