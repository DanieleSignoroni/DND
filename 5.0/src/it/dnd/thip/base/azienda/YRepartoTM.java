...
public class YRepartoTM extends RepartoTM {
	...
	public static final String AGV_NON_DEFAULT = "AGV_NON_DEFAULT";
	
	public static final String TIPO_GESTIONE_PERS = "TIPO_GESTIONE_PERS"; //Fix 72036
	
	public static final String LOGICA_MISSIONI_TOYOTA = "LOGICA_MISSIONI_TOYOTA";
	...
	protected void initializeRelation() throws SQLException {
		...
		addAttributeOnTable("AgvNonDefault", AGV_NON_DEFAULT, TABLE_NAME_EXT);
		addAttributeOnTable("TipoGestionePers", TIPO_GESTIONE_PERS, TABLE_NAME_EXT); //Fix 72036
		
		addAttributeOnTable("LogicaMissioniToyota", LOGICA_MISSIONI_TOYOTA, TABLE_NAME_EXT);
