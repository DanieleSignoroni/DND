 ...
 * 71994	10/06/2025	DSSOF3	 Cambiare chiave e aggiungere articolo
 */
...
public abstract class YGestioneUdsPickingProdPO extends EntitaAzienda implements BusinessObject, Authorizable, Deletable, Conflictable {
	...
	public void setKey(String key) {
		...
		setIdCodiceLista(KeyHelper.getTokenObjectKey(key, 4));
		setIdCodiceRigaLista(KeyHelper.stringToIntegerObj(KeyHelper.getTokenObjectKey(key, 5)));
	}
	...
	public String getKey() {
		...
		String idCodiceTl = getIdCodiceLista();
		Integer idCodiceRl = getIdCodiceRigaLista();
		Object[] keyParts = { idAzienda, numeroRitorno, idUds, idCodiceTl, idCodiceRl };
