...
public class YRilevDatiPrdTSFormActionAdapter extends RilevDatiPrdTSFormActionAdapter {
	...
	public static final String CHIUSURA_LISTA_TESTA = "CHIUSURA_LISTA_TESTA";
	public static final String CONFERMA_CHIUSURA_LISTA_TESTA = "CONFERMA_CHIUSURA_LISTA_TESTA";
	...
	protected void otherActions(ClassADCollection cadc, ServletEnvironment se) throws ServletException, IOException {
		...
		}else if(azione.equals(CHIUSURA_LISTA_TESTA)) {
			azioneChiusuraListaTesta(azione,se);
		}else if(azione.equals(CONFERMA_CHIUSURA_LISTA_TESTA)) {
			azioneConfermaChiusuraListaTesta(azione,se);
		}else {
			super.otherActions(cadc, se);
		}
	}

	protected void azioneConfermaChiusuraListaTesta(String azione, ServletEnvironment se) throws ServletException, IOException {
		se.getRequest().setAttribute("Action", azione);
		se.sendRequest(getServletContext(),  se.getServletPath() + "it.dnd.thip.produzione.raccoltaDati.web.AzioneConfermaChisuraListaTesta", true);
	}

	protected void azioneChiusuraListaTesta(String azione, ServletEnvironment se) throws ServletException, IOException {
		String url = "it/dnd/thip/produzione/raccoltaDati/YChiusuraListaTesta.jsp";
	...
	protected void azioneGeneraUdsAutomaticamente(String azione, ServletEnvironment se) throws ServletException, IOException {
		se.getRequest().setAttribute("Action", azione);
		se.sendRequest(getServletContext(),  se.getServletPath() + "it.dnd.thip.produzione.raccoltaDati.web.AzioneGeneraUdsAutomaticamente", true);
	}
